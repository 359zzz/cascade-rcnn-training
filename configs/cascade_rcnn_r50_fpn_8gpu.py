...
data_root = '/home/unitree/my_opencv/data/'

metainfo = dict(
    classes=('object_1', 'object_2', 'object_3', 'object_4', 'object_5', 'object_6'),
...
model = dict(
    ...
    rpn_head=dict(
        ...
        loss_bbox=dict(type='SmoothL1Loss', beta=1.0 / 9.0, loss_weight=1.0)  # 修复：使用 SmoothL1Loss
    ),
    roi_head=dict(
        type='CascadeRoIHead',
        num_stages=3,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='synthetic_train/images/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='synthetic_val/images/'),
        test_mode=True,
...
work_dir = '/home/unitree/my_opencv/work_dirs/cascade_rcnn_r50_fpn_8gpu'